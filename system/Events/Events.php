...
if (!defined('EVENT_PRIORITY_LOW')) define('EVENT_PRIORITY_LOW', 200);
if (!defined('EVENT_PRIORITY_NORMAL')) define('EVENT_PRIORITY_NORMAL', 100);
if (!defined('EVENT_PRIORITY_HIGH')) define('EVENT_PRIORITY_HIGH', 10);
